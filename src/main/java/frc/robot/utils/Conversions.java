...
public class Conversions {
    ...
    /**
     * Converts an AprilTag ID and scoring location into a field-relative Pose2d for
     * scoring.
     * Uses the AprilTagFieldLayout to determine the base position and applies
     * appropriate offsets.
     * 
     * @param apriltagID    The ID of the AprilTag near the desired scoring location
     *                      (1-5)
     * @param scoreLocation The desired scoring position (LEFT or RIGHT) relative to
     *                      the AprilTag
     * @return A Pose2d representing the scoring position and rotation in field
     *         coordinates
     * @throws IllegalArgumentException if the AprilTag ID is invalid or the pose
