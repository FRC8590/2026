...
/**
 * PreciseAlignment command that drives the robot to a target pose with high
 * precision.
...
public class PreciseAlignment extends Command {
    ...
    public void execute() {
        ...
        SmartDashboard.putNumber("PID Error X",
                m_roughAlignmentComplete ? currentPose.getX() - m_targetPose.getX()
                        : currentPose.getX() - m_targetPose.getX());

        SmartDashboard.putNumber("PID Error Y",
                m_roughAlignmentComplete ? currentPose.getY() - m_targetPose.getY()
                        : currentPose.getY() - m_targetPose.getY());

        SmartDashboard.putNumber("PID Error Rotation",
                m_roughAlignmentComplete ? currentPose.getRotation().minus(m_targetPose.getRotation()).getDegrees()
